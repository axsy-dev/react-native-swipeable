    ...
    value: function _renderButtons(buttons, isLeftButtons) {
      ...
      return buttons.map(function (buttonContent, index) {
        ...
        return _react2.default.createElement(
          ...
          { manipulationModes: ['translateX'], key: index, style: buttonStyle },
          buttonContent
        );
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        canSwipeRight && _react2.default.createElement(
          _reactNative.Animated.View,
          { manipulationModes: ['translateX'], style: [{ transform: transform, marginLeft: -width, width: width }, leftContainerStyle] },
          leftContent || this._renderButtons(leftButtons, true)
        ),
        _react2.default.createElement(
          _reactNative.Animated.View,
          { manipulationModes: ['translateX'], style: [{ transform: transform }, styles.content, contentContainerStyle] },
          children
        ),
        canSwipeLeft && _react2.default.createElement(
          _reactNative.Animated.View,
          { manipulationModes: ['translateX'], style: [{ transform: transform, marginRight: -width, width: width }, rightContainerStyle] },
